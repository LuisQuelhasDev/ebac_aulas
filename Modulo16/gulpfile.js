...
const sass = require('gulp-sass')(require('sass'));//Integra o Gulp e SASS. E compila
...
function compilaSass(){
    return gulp.src('./source/styles/main.scss')//Pega os arquivos fonte.
        ...
        .pipe(sass({style: 'compressed'}))//Compila.
        .pipe(sourcemaps.write('./maps'))
        .pipe(gulp.dest('./build/styles'));//Envia os arquivos.
}
